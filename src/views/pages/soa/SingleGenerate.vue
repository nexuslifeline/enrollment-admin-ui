<template>
  <CenterContainer>
    ...
    <Card title="Generate Statement of Account" :hasFooter="true">
      <InputGroup>
        <InputContainer>
          <b-form-group>
...
<script>
  ...
  export default {
    ...
    methods: {
      onGenerate() {
        const { amount, term, student: { latestAcademicRecord }, dueDate } = this.forms.billing.fields;
        ...
        this.generateSoa(latestAcademicRecord?.id, payload).then(({ data }) => {
