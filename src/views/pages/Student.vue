                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            >
                              ...
                              <b-form-select-option
                                v-for="civilStatus in options.civilStatuses
                                  .items.values"
                                :key="civilStatus.id"
                    ...
                    <b-tab>
                      ...
                      <b-row>
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              v-model="
                                forms.address.fields.currentHouseNoStreet
                              "
                              :state="
                                forms.address.states.addressCurrentHouseNoStreet
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressCurrentBarangay
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressCurrentCityTown
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressCurrentProvince
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressCurrentPostalCode
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-select
                              ...
                              :state="
                                forms.address.states.addressCurrentCountryId
                              "
                            >
                              <template v-slot:first>
                                <b-form-select-option :value="null" disabled
                              ...
                              <b-form-select-option
                                v-for="country in options.countries.items
                                  .values"
                                :key="country.id"
                                :value="country.id"
                              >
                        ...
                        <b-col md="4">
                          <b-form-group>
                            <label class="required"
                              >Home Landline/Mobile No.</label
                            >
                            <b-form-input
                              v-model="
                                forms.address.fields.currentHomeLandlineMobileNo
                              "
                              :state="
                                forms.address.states
                                  .addressCurrentHomeLandlineMobileNo
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                              {{
                                forms.address.errors
                                  .addressCurrentHomeLandlineMobileNo
                              }}
                            </b-form-invalid-feedback>
                          </b-form-group>
                        ...
                        <b-col md="12">
                          <b-form-group>
                            ...
                            <b-form-textarea
                              rows="3"
                              v-model="
                                forms.address.fields.currentCompleteAddress
                              "
                              :state="
                                forms.address.states
                                  .addressCurrentCompleteAddress
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                      ...
                      <b-row>
                        ...
                        <b-col md="6" class="text-right">
                          <b-form-checkbox @input="onSameAddress($event)"
                            >Same as Current Address</b-form-checkbox
                          >
                        </b-col>
                      </b-row>
                      <b-row>
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              v-model="
                                forms.address.fields.permanentHouseNoStreet
                              "
                              :state="
                                forms.address.states
                                  .addressPermanentHouseNoStreet
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressPermanentBarangay
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressPermanentCityTown
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressPermanentProvince
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-input
                              ...
                              :state="
                                forms.address.states.addressPermanentPostalCode
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="4">
                          <b-form-group>
                            ...
                            <b-form-select
                              ...
                              :state="
                                forms.address.states.addressPermanentCountryId
                              "
                            >
                              <template v-slot:first>
                                <b-form-select-option :value="null" disabled
                                  >--Select Contry --</b-form-select-option
                                >
                              </template>
                              <b-form-select-option
                                v-for="country in options.countries.items
                            ...
                            <b-form-input
                              v-model="
                                forms.address.fields
                                  .permanentHomeLandlineMobileNo
                              "
                              :state="
                                forms.address.states
                                  .addressPermanentHomeLandlineMobileNo
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                        ...
                        <b-col md="12">
                          <b-form-group>
                            ...
                            <b-form-textarea
                              rows="3"
                              v-model="
                                forms.address.fields.permanentCompleteAddress
                              "
                              :state="
                                forms.address.states
                                  .addressPermanentCompleteAddress
                              "
                              debounce="500"
                            />
                            <b-form-invalid-feedback>
                          ...
                          <b-row>
                            <b-col md="6">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.family.fields.parentGuardianName
                                  "
                                  :state="
                                    forms.family.states.familyParentGuardianName
                                  "
                                  debounce="500"
                                />
                                <b-form-invalid-feedback>
                            ...
                            <b-col md="6">
                              <b-form-group>
                                <label class="required"
                                  >Parent/Guardian Contact No.</label
                                >
                                <b-form-input
                                  v-model="
                                    forms.family.fields.parentGuardianContactNo
                                  "
                                  :state="
                                    forms.family.states
                                      .familyParentGuardianContactNo
                                  "
                                  debounce="500"
                                />
                                <b-form-invalid-feedback>
                      ...
                      <b-row>
                        <b-col md="5">
                          <b-form-group>
                            ...
                            <b-form-input
                              v-model="
                                forms.education.fields.lastSchoolAttended
                              "
                              debounce="500"
                            />
                          </b-form-group>
                        ...
                        <b-col md="2">
                          <b-form-group>
                            ...
                            <b-form-input
                              v-model="
                                forms.education.fields.lastSchoolYearFrom
                              "
                              debounce="500"
                            />
                          </b-form-group>
                          ...
                          <b-row>
                            <b-col md="5">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.education.fields.elementaryCourse
                                  "
                                  debounce="500"
                                />
                              </b-form-group>
                            ...
                            <b-col md="2">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.education.fields
                                      .elementaryCourseYearFrom
                                  "
                                  debounce="500"
                                />
                              </b-form-group>
                          ...
                          <b-row>
                            <b-col md="5">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.education.fields.highSchoolCourse
                                  "
                                  debounce="500"
                                />
                              </b-form-group>
                          ...
                          <b-row>
                            <b-col md="5">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.education.fields.seniorSchoolCourse
                                  "
                                  debounce="500"
                                />
                              </b-form-group>
                        ...
                        <b-col md="12">
                          <b-row>
                            <b-col md="5">
                              <b-form-group>
                                <label
                                  >College Degree(if graduated) or
                                  Tertiary</label
                                >
                                <b-form-input
                            ...
                            <b-col md="2">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.education.fields.collegeDegreeYearFrom
                                  "
                                  debounce="500"
                                />
                              </b-form-group>
                            ...
                            <b-col md="2">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.education.fields.collegeDegreeYearTo
                                  "
                                  debounce="500"
                                />
                              </b-form-group>
                            ...
                            <b-col md="3">
                              <b-form-group>
                                ...
                                <b-form-input
                                  v-model="
                                    forms.education.fields.collegeDegreeHonors
                                  "
                                  debounce="500"
                                />
                              </b-form-group>
...
export default {
  ...
  methods: {
    ...
    setUpdateStudent(row) {
      ...
      if (item.address) copyValue(item.address, address.fields);

      if (item.family) copyValue(item.family, family.fields);

      if (item.education) copyValue(item.education, education.fields);
    ...
    onSameAddress(isSame) {
      ...
      if (isSame) {
        ...
        address.permanentHomeLandlineMobileNo =
          address.currentHomeLandlineMobileNo;
      } else {
