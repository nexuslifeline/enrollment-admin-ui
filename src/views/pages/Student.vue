						...
						>
							...
							<template v-slot:cell(action)='row'>
								<b-dropdown right variant='link' toggle-class='text-decoration-none' no-caret>
									...
									</template><b-dropdown-item @click='showModalApproval=true'>Approve</b-dropdown-item><b-dropdown-item @click='showModalRejection=true'>Reject</b-dropdown-item><b-dropdown-item @click='row.toggleDetails'>View Details</b-dropdown-item>
								</b-dropdown>
							</template>
